...
const char* const HeaderFields::KStringAuthorization = "Authorization";
const char* const HeaderFields::KStringDate = "Date";
...
const char* const HeaderFields::KStringMicroMessenger = "Wildfire Chat";
